...
case class LifePartner(name: String) { // default is this =>
...
/**
  * Specifying dependency on the type
  * without specifying actual inheritance hierarchy
  */
import com.typesafe.scalalogging._
//Means LazyLogging must be there whenever I create Loves
